...
function App() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden flex flex-col lg:flex-row items-stretch bg-gradient-to-br from-blue-500 via-sky-300 to-white relative">
      {/* Decorative backgrounds, never cause scroll */}
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="hidden sm:block absolute left-0 top-0 w-1/2 h-72 bg-blue-300 opacity-20 blur-3xl rounded-full"></div>
        <div className="hidden md:block absolute right-0 bottom-0 w-2/3 h-[45vh] bg-gradient-to-br from-sky-200 via-blue-100 to-white opacity-50"></div>
      </div>
      <main className="relative z-10 flex flex-col lg:flex-row w-full min-h-screen">
        {/* Weather Panel */}
        <section className="flex-1 flex items-center justify-center px-2 py-8">
          <div className="w-full max-w-xl rounded-3xl px-4 py-8 sm:px-8 sm:py-14 bg-white/90 backdrop-blur-2xl border border-blue-100 shadow-2xl transition duration-300 flex flex-col">
            {/* Header */}
        ...
        {/* Plan Your Day Panel */}
        <aside className="flex-1 flex items-center justify-center px-2 py-8 bg-gradient-to-b from-blue-300/70 to-sky-100/80">
          <div className="w-full h-full min-h-[300px] rounded-3xl shadow-lg border border-blue-100 flex flex-col items-center justify-center p-8 bg-white/70">
            <div className="flex items-center justify-center mb-8">
              <span className="text-[5rem] md:text-[8rem]">🌤️</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-3 text-center">
              Plan Your Day
            </h2>
            <ul className="text-blue-700 text-lg font-medium space-y-2 text-center">
              <li>• Accurate weather at your fingertips</li>
              <li>• Live search, real location info</li>
              <li>• Responsive and beautiful UI</li>
              <li>• Works on every device</li>
            </ul>
            <div className="mt-8 text-center text-blue-600 italic">
...
function WeatherStat({ label, value, colSpan }) {
  return (
    <div className={`bg-sky-50 rounded-lg p-4 flex flex-col items-center shadow-sm w-full ${colSpan === 2 ? "col-span-2" : ""}`}>
